...
function guardarEdicion() {
  ...
  const personas = Number.parseInt(document.getElementById("edit-personas").value)
...
// Función para manejar responsive - AÑADIDO
...
// Prevenir recarga al usar botón atrás - AÑADIDO
